...
//
///**
// * Code taken from Assignment 6 - but modified
// * @author nicole
...
//    	//assign node with parameter data
...
//       
//    /**
//     * Insert a new node with data to left
//     **/
//    public void insertLeft( LinkedListNode<T> currentNode, T data )
//    {
//    	//create new LinkedListNode
//    	LinkedListNode<T> newNode = new LinkedListNode<T>();
//    	//assign node with parameter data
//    	newNode.setData(data);
//    	//assign left pointer to this node
//    	currentNode.setLeft(newNode);    	
//    }
//       
//    /**
//     * Insert a new node with data to right
//     */
//    public void insertRight( LinkedListNode<T> currentNode, T data )
//    {
//    	//create new LinkedListNode
//    	LinkedListNode<T> newNode = new LinkedListNode<T>();
//    	//assign node with parameter data
